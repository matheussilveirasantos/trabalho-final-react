  ...
  return (
    <div className={styles.page}>
      <div className={styles.topBar}>
        ...
        <h2 className={styles.pageTitle}>Cadastro de Produto</h2>
      </div>
      ...
      <div className={styles.card}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className={styles.form} noValidate>
          <div className={styles.field}>
            ...
            <input {...register('title')} className={`${styles.input} ${errors.title ? styles.inputError : ''}`} placeholder="Nome do produto"/>
          ...
          <div className={styles.row}>
            <div className={styles.field}>
              ...
              <input {...register('price')} type="number" step="0.01" className={`${styles.input} ${errors.price ? styles.inputError : ''}`} placeholder="0.00" />
              {errors.price && <span className={styles.fieldError}>{errors.price.message}</span>}
            </div>

            <div className={styles.field}>
              <label className={styles.label}>Categoria</label>
              <select {...register('category')} className={`${styles.input} ${errors.category ? styles.inputError : ''}`}>
          ...
          <div className={styles.field}>
            ...
            <input {...register('image')} className={`${styles.input} ${errors.image ? styles.inputError : ''}`} placeholder="https://..."/>
            {errors.image && <span className={styles.fieldError}>{errors.image.message}</span>}
          </div>

          <div className={styles.field}>
            <label className={styles.label}>Descrição</label>
            <textarea {...register('description')} className={`${styles.input} ${styles.textarea} ${errors.description ? styles.inputError : ''}`} placeholder="Descreva o produto..." rows={4}/>
          ...
          <div className={styles.formActions}>
            ...
            <Button variant="default" onClick={loading ? undefined : undefined} type="submit" disabled={loading}>
